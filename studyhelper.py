...
###############################################################################
# 여기에 OpenAI API 키를 직접 하드코딩 (데모 용도)
###############################################################################
OPENAI_API_KEY = "sk-YourOpenAIKeyGoesHere"  # 실제 키로 교체
